...
import 'package:hello_chat/FrontEnd/Services/ChatManagement/chat_screen.dart';
import 'package:hello_chat/FrontEnd/Services/search_screen.dart';
...
class _ChatAndActivityScreenState extends State<ChatAndActivityScreen> {
  ...
  final List<String> _allUserConnectionActivity = ['HelloChat', 'Kisara'];
